...
DYNALIB_FN(1, hal_nfc, hal_nfc_type2_set_payload, int(const void*, size_t, void*))
DYNALIB_FN(2, hal_nfc, hal_nfc_type2_start_emulation, int(void*))
DYNALIB_FN(3, hal_nfc, hal_nfc_type2_stop_emulation, int(void*))
DYNALIB_FN(4, hal_nfc, hal_nfc_type2_set_callback, int(hal_nfc_event_callback_t, void*))
